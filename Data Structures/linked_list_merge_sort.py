...
def split(linked_list):
    """
    Divide the unsorted list at midpoint into sublinkedlists
...
def merge_sort(linked_list):
    ...
    - Recursively divide the linked list into sublists containing a sigle node
...
sorted_linked = merge_sort(new_linked)
